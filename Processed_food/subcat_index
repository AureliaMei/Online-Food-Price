...
# --- CONFIGURATION (Cấu hình cho Processed_Food) ---
csv_folder = '/Users/my/Online Food Price/Processed_Food/CSV'
lookup_file = '/Users/my/Online Food Price/Processed_Food/cat_lookup_table.csv'
output_index_file = '/Users/my/Online Food Price/Processed_Food/jevons_price_index.csv'
...
def main():
    ...
    print(f"Found {len(files)} files. Starting Jevons index calculation for Processed Food...")
    ...
    for file in files:
        ...
        try:
            ...
            # --- CÁC NGÀY TIẾP THEO ---
                ...
                # Duyệt qua từng nhóm hàng đã có trong lịch sử (Bánh mì, Xúc xích...)
    ...
    if results:
        ...
        print(f"\n✅ Jevons Index calculated for Processed Food. Saved to: {output_index_file}")
