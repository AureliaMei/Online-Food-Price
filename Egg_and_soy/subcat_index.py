...
lookup_file = '/Users/my/Online Food Price/Egg_and_soy/cat_lookup_table.csv'
output_index_file = '/Users/my/Online Food Price/Egg_and_soy/jevons_price_index.csv'
            ...
            # --- SUBSEQUENT DAYS ---
                ...
                for sub in history.keys():
                    ...
                    if not matched.empty:
                        ...
                        # Carry over previous index if no match
