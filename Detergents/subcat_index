...
# --- CONFIGURATION ---
# Updated paths for Detergents
csv_folder = '/Users/my/Online Food Price/Detergents/CSV'
lookup_file = '/Users/my/Online Food Price/Detergents/cat_lookup_table.csv'
output_index_file = '/Users/my/Online Food Price/Detergents/jevons_price_index.csv'
...
def main():
    ...
    for file in files:
        ...
        try:
            ...
            # Merge with lookup to get subcategories
            # This attaches "Nước Giặt", "Nước Rửa Chén", etc. to each product
            ...
            # --- SUBSEQUENT DAYS ---
                ...
                # Calculate index for each subcategory tracking in history
                for sub in history.keys():
                    ...
                    # Filter out zero prices to prevent division errors
                    ...
                    if not matched.empty:
                        ...
                        # If no matched products (e.g., completely different items sold today), 
                        # carry over previous index (Flat line)
